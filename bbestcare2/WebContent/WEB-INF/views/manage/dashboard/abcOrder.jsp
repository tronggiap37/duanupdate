						...
						$('#add')
								.click(
										function() {
											...
											$('#dynamic_field')
													.append(
															'<tr id="row'+i+'"> <td><input id="txtDate" style="font-weight:bold; margin-left:5px; border: 1px solid #ccc;border-radius: 3px;width: 300px;height: 40px;" type="date" name="Dated" ></td> <td> <button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
										});
...
<jsp:include page="../headcaring.jsp"></jsp:include>
<body id="page-top">
			...
			<div class="card-body">
				<div class="table-responsive">
					...
					<div style="width: 50%; margin: 0 auto;">
						<form method="post" action="manage/dashboard/orderLichNhanVien.htm">
						...
						<label>Địa chỉ</label>
						<div class="form-group">
				<select name="city" id="countySel" style="width: 32%; height: 30px;border: 1px solid #ccc;border-radius: 3px;">
				  <option value="Hà Nội" selected="selected" disabled="disabled" class="form-control">Thành phố</option>
				 </select>
				<select name="district" id="stateSel" style="width: 33%; height: 30px;border: 1px solid #ccc;border-radius: 3px;">
				   <option value="" selected="selected" disabled="disabled" class="form-control" >Quận,Huyện</option> 
				</select>
				<select name="ward" id="districtSel" style="width: 33%; height: 30px;border: 1px solid #ccc;border-radius: 3px;">
				    <option value="" selected="selected" disabled="disabled" class="form-control" >Phường</option>
						...
						<div style="width: 20%;float: left; "><input class="form-check-input" type="checkbox" name="ca" value="1">7h10-9h00 </div>
						<div style="width: 20%;float: left; "><input class="form-check-input" type="checkbox" name="ca" value="2">9h10-11h00 </div>
						<div style="width: 20%;float: left; "><input class="form-check-input" type="checkbox" name="ca" value="3">14h10-16h00 </div>
						<div style="width: 20%;float: left; "><input class="form-check-input" type="checkbox" name="ca" value="4">16h10-18h00 </div>
						</div>	
						...
						<div class="table-responsive">
							<table class="table table-borderless" id="dynamic_field">
								<tr>
									<td><input id="txtDate" style="font-weight:bold; margin-left:5px; border: 1px solid #ccc;border-radius: 3px;width: 300px;height: 40px;" type="date" name="Dated"></td>
									<td><button type="button" name="add" id="add"
											class="btn btn-primary">Thêm lịch</button></td>
								</tr>
							</table>
							</div>
...
<jsp:include page="../footcaring.jsp"></jsp:include>
</html>