...
<sql:query dataSource="${snapshot}" var="result2">
         select * from OrderDetail  where Staff = '${staff.phone}' and Note = N'Đã thanh toán' or Note = N'Đã hủy' ;
      </sql:query>
...
<jsp:include page="../headcaring.jsp" />
<body id="page-top">
  		...
  		<table border="1" width="100%" class="table table-bordered" style="border: 1px solid #dddfeb;border-radius:3px;" id="example">
			...
			<c:forEach var="row" items="${result.rows}">
				<tr>
					...
					<td scope="row"><div class="cancel"><a onclick="return confirm('Bạn có chắc chắn muốn hủy lịch?');" href="manage/dashboard/delete1/${row.id}.htm" style="color:white;">Hủy</a></div>
					<i ></i>
					</td>
				</tr>
			</c:forEach>
  		...
  		<table border="1" width="100%" class="table table-bordered" style="border: 1px solid #dddfeb;border-radius:3px;" id="example2">
			...
			<c:forEach var="row1" items="${result1.rows}">
				<tr>
					...
					<td scope="row"><div class="update"><a href="manage/dashboard/update/${row1.id}.htm" style="color: white;">Cập nhật</a></div>
  ...
  <h3>Lịch sử</h3>
  		<table border="1" width="100%" class="table table-bordered" style="border: 1px solid #dddfeb;border-radius:3px;" id="example3">
			...
			<c:forEach var="row2" items="${result2.rows}">
				<tr>
					<td scope="row"><c:out value="${row2.ID_Orders}" /></td>
...
<jsp:include page="../footcaring.jsp" />
</html>
