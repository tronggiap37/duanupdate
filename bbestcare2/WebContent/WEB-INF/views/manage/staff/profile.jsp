...
<body >
	...
	<div class="center-container">
		...
		<div style="border:1px solid #ccc; background-color: #ccc;">
			<div style="font-size: 40px;font-weight: bolder;position: absolute;top: 20px;right: 30px;">
				<a href="../../../client/calendarOrderCustomer.htm" style="color: red;">X</a>
			</div>
			...
			<div class="profile">
				<div class="wrap">
					<div class="profile-main">
						...
						<h1 style="text-transform: uppercase;font-size: 35px;color: #17449e;font-weight: bold;">Thông tin cá nhân</h1>
						<br>
